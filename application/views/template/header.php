		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top"><img src="https://res.cloudinary.com/oli37/image/upload/c_scale,w_250/v1609943118/valorant_site/valorant_logo_zce2qv.png" alt="Lattes theme logo"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>admin">Login</a>
						</li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
